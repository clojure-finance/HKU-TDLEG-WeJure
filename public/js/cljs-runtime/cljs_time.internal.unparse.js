...
var periods__$1 = cljs.core.vec((function (){var G__38150 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38149_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__38149_SHARP_,(0),(3));
}),G__38150);
} else {
return G__38150;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__38164){
var vec__38165 = p__38164;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38165,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38165,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__38168 = pattern;
switch (G__38168) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38168)].join('')));
...
return p1__38169_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__38170_SHARP_){
return p1__38170_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__38171_SHARP_){
return p1__38171_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__38172_SHARP_){
return p1__38172_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__38173_SHARP_){
return p1__38173_SHARP_.getHours();
});

break;
case "day":
return (function (p1__38174_SHARP_){
return p1__38174_SHARP_.getDate();
});

break;
case "month":
return (function (p1__38175_SHARP_){
return p1__38175_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__38176_SHARP_){
return p1__38176_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38177__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__38180){
...
var key = first__38183;
var args = seq__38182__$1;
var G__38184 = key;
...
break;
case "ordinal-suffix":
var vec__38185 = (function (){var G__38188 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__38188) : syntax_list.call(null,G__38188));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38184__$1)].join('')));
...
var d = value;
var G__38192 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__38193 = G__38192;
...
var unparser = first__38195;
var more = seq__38194__$1;
var s = "";
var d__$1 = d;
var G__38192__$1 = G__38192;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__38202 = G__38192__$1;
...
var unparser__$1 = first__38204;
var more__$1 = seq__38203__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__38206 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38206,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38206,(1),null);
var G__38226 = d__$3;
var G__38227 = more__$1;
var G__38228 = s__$3;
d__$1 = G__38226;
G__38192__$1 = G__38227;
s__$1 = G__38228;
continue;
}
break;

...
if(!$jscomp$async$this._detectedAddress){now=yield $jscomp$async$this.eth.net.getNetworkType();block=config.addresses[now];if("undefined"===typeof block)throw Error("ENS is not supported on network "+now);$jscomp$async$this._detectedAddress=block}return $jscomp$async$this._detectedAddress})};module.exports=ENS}

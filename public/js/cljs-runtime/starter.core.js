...
return (new web3.eth.Contract(abi,"0xe6d4bB8Bb9f83965cCA23cf17A774b2Ae99E0BEe"));
});
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27969)].join('')));

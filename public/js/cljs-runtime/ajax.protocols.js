...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_37398 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_37398(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_37399 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_37399(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_37400 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_37400(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_37401 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_37401(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_37402 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_37402(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_37403 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_37403(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_37404 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_37404(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_37405 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_37405(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_37406 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_37406(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_37407 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_37407(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k37377,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37377,else__4505__auto__);
...
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37383,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37383,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37376){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37378,other37379){
var self__ = this;
var this37378__$1 = this;
return (((!((other37379 == null)))) && ((((this37378__$1.constructor === other37379.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37378__$1.status,other37379.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37378__$1.body,other37379.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37378__$1.status_text,other37379.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37378__$1.headers,other37379.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37378__$1.was_aborted,other37379.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37378__$1.__extmap,other37379.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k37377){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37377);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__37376){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__37394 = cljs.core.keyword_identical_QMARK_;
var expr__37395 = k__4511__auto__;
if(cljs.core.truth_((pred__37394.cljs$core$IFn$_invoke$arity$2 ? pred__37394.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__37395) : pred__37394.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__37395)))){
return (new ajax.protocols.Response(G__37376,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37394.cljs$core$IFn$_invoke$arity$2 ? pred__37394.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__37395) : pred__37394.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__37395)))){
return (new ajax.protocols.Response(self__.status,G__37376,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37394.cljs$core$IFn$_invoke$arity$2 ? pred__37394.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__37395) : pred__37394.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__37395)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__37376,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37394.cljs$core$IFn$_invoke$arity$2 ? pred__37394.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__37395) : pred__37394.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__37395)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__37376,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37394.cljs$core$IFn$_invoke$arity$2 ? pred__37394.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__37395) : pred__37394.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__37395)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__37376,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__37376),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__37376){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__37376,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__37380){
var extmap__4542__auto__ = (function (){var G__37397 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37380,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__37380)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__37397);
} else {
return G__37397;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__37380),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__37380),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__37380),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__37380),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__37380),null,cljs.core.not_empty(extmap__4542__auto__),null));
});

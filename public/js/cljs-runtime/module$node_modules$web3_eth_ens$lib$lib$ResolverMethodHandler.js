...
resolver.options.address+'". ')}if(!supported)throw errors.ResolverMethodMissingError(resolver.options.address,methodName);}})};module.exports=ResolverMethodHandler}

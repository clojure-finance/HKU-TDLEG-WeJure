...
var i_29657 = (0);
while(true){
if((i_29657 < arr.length)){
(arr[i_29657] = null);

var G__29659 = (i_29657 + (1));
i_29657 = G__29659;
continue;
} else {
}
...
var i_29670 = (self__.level + (1));
while(true){
if((i_29670 <= (new_level + (1)))){
(update[i_29670] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29672 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29672[i]));
} else {
x__$2.forward.push((((i < links_29672.length))?(links_29672[i]):null));
}

if((i < links_29672.length)){
(links_29672[i] = x__$2);
} else {
links_29672.push(x__$2);
}
...
if((x__$1 === (((i_29674 < links_29675.length))?(links_29675[i_29674]):null))){

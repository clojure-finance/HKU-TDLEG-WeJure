...
var G__37004 = o;
(G__37004[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37007 = o;
(G__37007[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__37021 = props;
var G__37021__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37021,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37021);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37021__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37031){
var map__37032 = p__37031;
var map__37032__$1 = cljs.core.__destructure_map(map__37032);
var props = map__37032__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37032__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37069){
var map__37070 = p__37069;
var map__37070__$1 = cljs.core.__destructure_map(map__37070);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37070__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__37102 = jsprops;
(G__37102["defaultValue"] = value);

(G__37102["onChange"] = (function (p1__37101_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37101_SHARP_);
}));
...
var vec__37104 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37104,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37104,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37104,(2),null);
...
var jsprops = ({"argv": v});
var temp__5757__auto___37127 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___37127 == null)){
} else {
var key_37128 = temp__5757__auto___37127;
(jsprops["key"] = key_37128);
}
...
var temp__5757__auto___37129 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___37129 == null)){
} else {
var key_37132 = temp__5757__auto___37129;
reagent.impl.template.oset(jsprops,"key",key_37132);
}
...
var G__37108 = reagent.impl.template.__GT_NativeWrapper();
(G__37108["name"] = c);
...
var G__37109 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37109) : reagent.impl.template.as_element.call(null,G__37109));
} else {
...
var len__4864__auto___37136 = arguments.length;
var i__4865__auto___37137 = (0);
while(true){
if((i__4865__auto___37137 < len__4864__auto___37136)){
args__4870__auto__.push((arguments[i__4865__auto___37137]));

var G__37138 = (i__4865__auto___37137 + (1));
i__4865__auto___37137 = G__37138;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37112){
var G__37113 = cljs.core.first(seq37112);
var seq37112__$1 = cljs.core.next(seq37112);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37113,seq37112__$1);
}));
...
break;
default:
var G__37141 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37141;
continue;
...
var n__4741__auto___37143 = a.length;
var i_37144 = (0);
while(true){
if((i_37144 < n__4741__auto___37143)){
(a[i_37144] = reagent.impl.template.as_element((a[i_37144])));

var G__37145 = (i_37144 + (1));
i_37144 = G__37145;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4741__auto___37146 = a.length;
var i_37147 = (0);
while(true){
if((i_37147 < n__4741__auto___37146)){
var val_37148 = (a[i_37147]);
if(((cljs.core.vector_QMARK_(val_37148)) && ((reagent.impl.template.key_from_vec(val_37148) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37147] = reagent.impl.template.as_element(val_37148));

var G__37149 = (i_37147 + (1));
i_37147 = G__37149;
continue;
} else {
}
...
var ctx = ({});
var vec__37116 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37116,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37116,(1),null);
...
var G__37119 = (cljs.core.count(argv) - first_child);
switch (G__37119) {
case (0):
